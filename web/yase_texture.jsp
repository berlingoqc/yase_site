...
<html>
	...
	<form method="post" action="/helios/api/yase/texture"
		enctype="multipart/form-data">
        
		Selectionner la texture a ajouter:
		<br />
	...
	List<String> texture = ys.GetTextureList(t.getId());
	%>

	<ul>	
	<%for(String s : texture) {%>
	<li ><a href="/helios/api/yase/texture?name=<%=s%>"><%=s%></a></li>
